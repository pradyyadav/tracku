...
"""
Tracku: Find Usernames Across Social Networks Module
...
module_name = "Tracku: Find Usernames Across Social Networks"
__version__ = "0.12.9"




class TrackuFuturesSession(FuturesSession):
    def request(self, method, url, hooks={}, *args, **kwargs):
        ...
        return super(TrackuFuturesSession, self).request(method,
                                                           url,
                                                           hooks=hooks,
                                                           *args, **kwargs)
...
def tracku(username, site_data, query_notify,proxy=None, timeout=None):
    """Run Tracku Analysis.
    ...
    session = TrackuFuturesSession(max_workers=max_workers,
...
def main():
    ...
    # Check for newer version of Tracku. If it exists, let the user know about it
    try:
        r = requests.get("https://raw.githubusercontent.com/pradyyadav/tracku/master/tracku/tracku.py")
        ...
        if remote_version != local_version:
            print("Update Available!\n" +
                  f"You are running version {local_version}. Version {remote_version} is available at https://git.io/tracku")
